        ...
        <section id='contactPage'>
            ...
            <div className='contact'>
                ...
                <form className='contactForm' ref={form} onSubmit={sendEmail}>
                    ...
                    <div className='links'>
                        <a href='https://github.com/Zapallit0' target='_blank' rel='nofollow'/><img src={GithubIcon} alt="Github" className='link'/>
                        <a href='https://twitter.com/Zapallito4u' target='_blank' rel='nofollow'/><img src={TwitterIcon} alt="Twitter" className='link'/>
                        <a href='https://www.youtube.com/channel/UCDpZLvsVyuSE_h7q6Jkj_lg' target='_blank' rel='nofollow'/><img src={YoutubeIcon} alt="Youtube" className='link'/>
                        <a href='https://www.instagram.com/jhersvinvillodas/' target='_blank' rel='nofollow'/><img src={InstagramIcon} alt="Instagram" className='link'/>
                    </div>
                </form>
            </div>
        </section>
