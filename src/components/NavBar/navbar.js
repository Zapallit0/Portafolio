...
import './navbar.css'
import logo from '../../assets/logoJhers.png'
  ...
  return (
    <nav className='navbar'>
        ...
        <div className='desktopMenu'>
            ...
            <Link activeClass='active' to='clients' spy={true} smooth={true} offset={-100} duration={500} className='desktopMenuListItem'>Technologies</Link>
        </div>
